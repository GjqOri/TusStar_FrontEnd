...
<!--                                class="img-fluid avatar avatar-medium d-block mx-auto rounded-pill" alt="">-->
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group app-label">
                                            ...
                                            <input type="text"  class="form-control resume"   v-model="birth"value="<fmt:formatDate value="  pattern="yyyy/MM/dd " >
                                   ...
                                   <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group app-label">
                                            ...
                                            <input id="university/college" type="text" class="form-control resume"
                                                placeholder="" v-model="department">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group app-label" m>
                                            ...
                                            <input type="text"  class="form-control resume"   v-model="timeOfEnrollment" value="<fmt:formatDate value="  pattern="yyyy/MM/dd " >
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group app-label">
                                            ...
                                            <textarea id="addition-information" rows="4" class="form-control resume"
                                                placeholder="" v-model="overHeadInfo"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group app-label">
                                            ...
                                            <textarea id="addition-information-1" rows="4" class="form-control resume"
                                                placeholder="" v-model="internInfo"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12 mt-4" style="margin-left: 45%;">
                    <input type="submit" id="submit" name="send" class="submitBnt btn btn-primary" style="font-size: 120%" value="保存简历"
                        v-on:click="insert()">
                </div>
            </div>
    </section>
                        ...
                        if(res.data.data=='have_resume'){
                            this.axios.get('/getResume').then(res=>{
                                if(res.data.success==true){
                                    ...
                                    console.log("简历"+this.resumeInfo.name)
