                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav m-auto ">
                                ...
                                <li class="nav-item" v-if="this.admin=='未登录'|| this.admin==null || typeof(this.admin) =='undefined'">
                                    <a href="/denglu" class="dropdown-toggle nixihuan yidong" >{{this.admin}}</a>
                                </li>
                                <li class="nav-item" v-else>
                                    <div class="dropdown-toggle nixihuan yidong" >{{admin}}</div>
                                    <ul class="dropdown-menu">
    ...
    export default {
        ...
        methods: {
            serch(){
                ...
                console.log("用户or企业  "+userOrCompany)
                if (userOrCompany == 1){
                    this.userOrCom = '1';
                    ...
                    this.axios.get('/getName').then(res=>{
                        ...
                        console.log("用户名称Head: "+this.admin)
                    }).catch(error=>{
                ...
                if (userOrCompany == 2){
                    ...
                    this.axios.get("/resumeExist").then(res=>{
                        ...
                        console.log("获取简历为 "+res.data.data)
                        console.log("获取简历为asa "+this.resumeExist)
                    }).catch(error=>{
                        console.log("获取简历失败")
                    })
                }
            ...
            logOut(){
                ...
                this.axios.get('/logOut').then(res=>{
                    if(res.data.data=="success"){
                        ...
                        console.log("退出"+res.data.data)
                        window.location="/"
                        // Cookies.remove("userOrCompany")
                        // Cookies.clear("userOrCompany")
