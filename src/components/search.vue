        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="岗位名称" v-model="workName" />
                </div>
            </div>
...
<!--                <button type="primary" @click="find()" class="find-btn">-->
<!--                    查找-->
        ...
        methods:{
            find()
            {
                ...
                this.axios.post('/searchJobs',qs.stringify({
                    ...
                    console.log("获得的岗位名称  "+ res.data.data.length)
                    ...
                    window.location='/jobList?jobName='+this.workName+'&workLocation='+this.workLocation+'&jobType='+this.jobType
                     console.log("返回信息aaaaaaa:"+res.data.data[0].jobName)
